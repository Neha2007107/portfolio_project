...
<div class="wrapper">
 ...
 ``         <h2 class="text-uppercase">information</h2>
          <p>
        Hii,we are welcoming you in this musical concert. and am sure you all are so excited to participate in this concert, so get ready to get lost n music of world.

             
          </p>
          <p class="text">
              <span>Sub Head:</span>
            Fiil this form to get invlove totally in this world.
     ...
     <form action="{{url('/save-store')}}" method ="post" class="form-right">
        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
          ...
          <div class="row">
              <div class="col-sm-6 mb-3">
                  ...
                  <input type="text" name="city" id="pwd" class="input-field">
              </div>
              <div class="col-sm-6 mb-3">
                  <label>Phone no.</label>
                  <input type="text" name="phone_no" id="Phone_no" class="input-field">
              </div>
            </div>
            <div class="mb-3">
